...
import org.apache.poi.impl.configuration.DefaultConfiguration;
import org.apache.poi.impl.style.defaults.DefaultStyleConfiguration;
...
public class WorkbookContextFactory {
    ...
    public WorkbookContextFactory(boolean useHSSF) {
